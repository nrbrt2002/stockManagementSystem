        ...
        <section>
            ...
            <div class="sidebar-left">
                <div class="sidebar-left-info">
                    ...
                    <ul class="side-navigation">
                        <li>
                            <a href="email.php"><i class="mdi mdi-email"></i> <span>FeedBack</span></a>
                        </li>
                        <li>
                            <a href="report.php"><i class="mdi mdi-file-multiple"></i> <span>Report</span></a>
                        </li>
                        <li>
                            <a href="users.php"><i class="mdi mdi-account-multiple"></i> <span>Users</span></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="body-content">
                ...
                <div class="header-section">
                    ...
                    <div class="logo" style="background-color: #8ba6f6;">
                        <a href="index.html">
                            <span class="logo-img">
                            ...
                            <ul class="notification-menu">
                                ...
                                <li>
                                    <a href="javascript:;" data-toggle="dropdown" style="padding: 0;">
                                        ...
                                        <span class="text-muted m-0"><?php echo $role; ?></span>
