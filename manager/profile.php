<?php include"manager-includes/manager-header.php";?>
            ...
            if(isset($_POST['edit_profile'])){
                $branch_name = $_POST['names'];
                $branch_location = $_POST['email'];
                $branch_phone = $_POST['phone'];

                $update_branch_query = mysqli_query($connection, "UPDATE users SET names = '$branch_name', email = '$branch_location', phone = '$branch_phone' WHERE id = $dataId ");
