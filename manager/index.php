        ...
        <div class="col-lg-12 col-sm-12">
            <div class="row">
                <div class="col-lg-3 col-sm-3">
                    <div class="widget-box  m-b-30  bg-white">
    ...
    function drawChart() {
        var data = google.visualization.arrayToDataTable([
            ...
            while ($row = mysqli_fetch_array($the_query)) {
                ...
                $the_query1 = mysqli_query($connection, "SELECT * FROM products");
                $count1 = mysqli_num_rows($the_query1);
             echo("['". $invoiceDatetime." ', ".$count.",".$count1."],");
